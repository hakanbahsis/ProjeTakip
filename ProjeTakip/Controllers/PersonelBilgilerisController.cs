...
namespace ProjeTakip.Controllers
{
    public class PersonelBilgilerisController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonelBilgileriId,Eposta,Sifre,Yetki,AdSoyad,TCNO,Departman,Gorevi,PozisyonAciklama,TelNo,Adres,MedeniHal,DogumTarihi,IseGirisTarihi")] PersonelBilgileri personelBilgileri)
        {
            if (ModelState.IsValid)
            {
